...
# os.path.join('pasta1', 'pasta2', 'arquivos.txt') retornaria 
...
# os.path.exists: verifica se o caminho especificado existe.
...
print(os.path.exists(caminho)) # False
print(os.path.exists('C:/Users/Hyago/Desktop/PythonExercicios')) # True

print(os.path.abspath('.')) # Retorna o caminho absoluto deste arquivo
print(caminho)
