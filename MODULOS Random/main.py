...
este módulo não deve ser usado para segurança ou uso criptográffico.
...
# randim.uniform(início, fim)
#     -> Gera um número flutuante aleatório dentro de um intervalo "sem passo"
r_uni = random.uniform(10, 20)
print(r_uni)

# random.shuffle(SequenciaMutável) -> Embaralha a lista original
nomes = ['Luiz', 'Maria', 'Joana', 'Helena']
...
# rando.choices(Iterável, k=N)
#     -> Escolhe elementos do iterável e retorna outro iterável (repetidamente)
novos_nomes = random.choices(nomes, k=3)
print(nomes)
print(novos_nomes)

# random.sample(Iterável, k=N)
#     -> Escolhe elementos do iterável e retonna outro iterável (não repete)
