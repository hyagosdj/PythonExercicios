...
class Caneta:
    def __init__(self, cor):
        ...
        self._cor_tampa = None # Nesse caso não tem no init, logo ele deve ser deixado assim. 
...
caneta = Caneta('Azul')
caneta.cor = 'Pink' # Error de atribuição | PARA CASOS EM QUE NÃO SE USOU O GETTER/SETTER
